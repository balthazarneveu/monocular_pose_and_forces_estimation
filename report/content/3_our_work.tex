...
\begin{itemize}
    ...
    \item 
        ...
        This cost term penalizes rapid movements or accelerations.
        $l_{\text{smooth}} = \sum_{j} ||v_j(q, \dot{q})||^2 + ||\alpha_j(q, \dot{q}, \ddot{q})||^2$
    penalizes high 3D linear velocities and accelerations for each joint $j$.
\end{itemize}
